...
A PSA 9 Umbreon VMAX Alt Art (Evolving Skies) — the "Moonbreon", an outlier well above the typical modern SIR — has sold in the $2,250-$2,300 range in 2026. A PSA 10 sells for $4,400-$4,600, still only a ~2x jump on a card whose PSA 10 pop runs into the thousands. You're paying a premium for a grade thousands of other collectors also hold; most modern SIRs sit far lower, closer to the range in the table below.
