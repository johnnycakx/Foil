  ...
  return (
    <section className="relative isolate overflow-hidden">
        ...
        {HERO_CARDS.map((c, i) => (
          ...
          >
            <HoloCard
              ...
              height={560}
              eager
              className="aspect-[5/7] w-24 overflow-hidden rounded-lg shadow-[0_10px_50px_-12px_rgba(248,245,240,0.35)] ring-1 ring-foil-cream/15 sm:w-32 md:w-36 lg:w-44"
            />
          </div>
        ))}
      </div>
      ...
      <div className="relative mx-auto w-full max-w-3xl px-5 pt-12 pb-20 text-center sm:px-8 sm:pt-14 sm:pb-28">
        ...
        <h1 className="font-display mx-auto mt-6 max-w-3xl text-[2.6rem] font-semibold leading-[1.02] tracking-[-0.015em] text-foil-cream sm:text-6xl md:text-7xl">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1fr_1.2fr]">
          <div>
            ...
            <Link
              ...
              className="mt-6 inline-block text-sm font-medium text-foil-cream underline decoration-foil-vermillion/50 underline-offset-4 transition hover:decoration-foil-vermillion"
            >
              Start filling yours →
            </Link>
          </div>
          ...
          <div className="rounded-3xl border border-foil-cream/10 bg-foil-night-2 p-4 sm:p-6">
