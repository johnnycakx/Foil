...
Near Mint (NM) does not mean the card looks like it just left the pack — that's Mint, which is a distinct and rarer standard. NM means the card has minimal imperfections that don't affect its perceived play or collector value at first glance.
...
Here's the financial reality: on TCGplayer in 2026, LP copies of popular cards typically price **30–50% below the NM market price** for the same card. On a $180 NM Umbreon VMAX (Evolving Skies, 215/203), LP copies are trading around $95–$110 (approximate). On a $45 NM Pikachu VMAX Rainbow Rare, LP sits closer to $25–$28.
...
1. **Charizard ex (Obsidian Flames, 223/197):** NM copies selling $175–$195 on eBay sold listings in Q1 2026. LP copies clearing $88–$105 — roughly a 50% haircut.
2. **Rayquaza VMAX (Evolving Skies, 217/203):** NM market around $130. LP market around $72. That's a $58 gap on a single card.
...
This mapping has a major implication for grading economics. As of 2026, PSA's standard service fee runs approximately **$25–$30 per card** (approximate, verify at PSA's current fee schedule). A raw NM card worth $45 that grades PSA 9 might sell for $130–$160 depending on the card and pop report. That's a $85–$115 flip on a $25–$30 fee — viable.
...
Foil's scan data — across 25 cards processed in the last 30 days — shows that multi-set Pokémon (those appearing in 4+ sets) are the most frequent source of condition-and-price mismatches, because sellers confirm the wrong card's price before grading the one they actually have.
