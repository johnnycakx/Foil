...
**Cross-refs.** `lib/buy-signal/{compute,reference,methodology-content}.ts`, `components/buy-signal-badge.tsx`, `app/(site)/pricing-methodology/page.tsx`, `app/(site)/cards/[slug]/page.tsx`, `lib/seo/quality-gates.ts` (Gate 13), ROADMAP #32 + #32.1, [ADR-026](#adr-026--quality-aware-listing-picker-replaces-lowest-price-wins), [R-008](RISKS.md).
