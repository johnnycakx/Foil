# Internal link suggestions for Near Mint vs Lightly Played Pokémon: The Condition Gap That Doubles Card Prices

Target: `/blog/near-mint-vs-lightly-played-the-difference-that-doubles-a-card-s-price`

## Existing posts that should link IN (5)

### eBay Sold vs TCGplayer Market Price: Which Is Real?
- **File:** `app/(site)/blog/posts/ebay-sold-averages-vs-tcgplayer-market-which-price-is-the-real-one.mdx`
...
- **Anchor:** near mint vs lightly played pokemon.
- **Target:** `/blog/near-mint-vs-lightly-played-the-difference-that-doubles-a-card-s-price`
- **Matched phrase:** `card valuation`
- **Context:** > Every Pokémon card valuation starts with three printed data points: **name**, **set code**, and **collector number**. These are non-negotiable. Identifying a card by artwork alone is the single most c
...
- **Target:** `/blog/near-mint-vs-lightly-played-the-difference-that-doubles-a-card-s-price`
- **Matched phrase:** `TCGplayer`
- **Context:** > Once the three fields are confirmed, Foil pulls pricing from eBay sold listings (Japanese-specific), TCGplayer market data where available, and PriceCharting's graded ladder, so you see the PSA 10 mul
...
- **Target:** `/blog/near-mint-vs-lightly-played-the-difference-that-doubles-a-card-s-price`
- **Matched phrase:** `TCGplayer`
- **Context:** > Why does this matter for value? Because collectors who search only "SIR" on TCGplayer will miss JP SAR listings entirely, and vice versa. That search fragmentation historically created arbitrage windo
...
- **Anchor:** near mint vs lightly played pokemon.
- **Target:** `/blog/near-mint-vs-lightly-played-the-difference-that-doubles-a-card-s-price`
- **Matched phrase:** `card condition`
- **Context:** > This question sits at the core of the <TopicLink href="/pokemon-card-condition-guide">Pokémon card condition guide</TopicLink>, and it's worth answering precisely, not with hand-waving about "astronom
