...
export const HOST_FAQS: readonly HostFaq[] = [
  ...
  },
  {
    ...
    answer:
      "The machine has a guaranteed-drop system with a refund sensor. If product doesn't drop, the customer is refunded automatically and the screen confirms it. Every machine also has a support code so customers report any issue directly to us, so your staff never handles refunds or complaints.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "If it's not pulling the numbers we'd expect, we first try adjusting the product mix to your customers. If it still isn't a fit, we pull it and relocate it, at no cost or hassle to you.",
  },
  {
